...
## +++++++++++++++++++++++++++++++++++++++++++
hist(hpcDatasubset$Global_active_power, main="Global Active Power", 
     xlab="Global Active Power (kilowatts)", ylab="Frequency", col="Red")

## Note that sometime Rstudio gives an error "Error in plot.new() : figure margins too large"
## This happens because the graphical display area (quadrant frame on the screen)
